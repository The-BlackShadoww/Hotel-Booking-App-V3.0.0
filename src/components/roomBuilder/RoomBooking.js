...
//     const isGenAvailable = props.customers.some((c) => c.type === "General");
//     const isGenPAvailable = props.customers.some(
//         (c) => c.type === "General premium"
//     );
//     const isSingleBedAvailable = props.customers.some(
//         (c) => c.type === "Single Bed"
//     );
//     const isDoubleBedAvailable = props.customers.some(
//         (c) => c.type === "Double Bed"
//     );
...
//                 className="border p-4 w-full my-4"
//             >
//                 <option value="No option left">No option left</option>
//             </select>
//         );
//     }
